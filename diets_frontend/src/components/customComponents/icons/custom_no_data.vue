<template>
  <div class="flex flex-col justify-center">
    <svg xmlns="http://www.w3.org/2000/svg" :height="height" :width="width" viewBox="0 0 647.63626 632.17383"
      ...
      <path class="primary-color" d="M801.81836,318.08691h-184a9.01015,9.01015,0,0,1-9-9v-44a9.01016,9.01016,0,0,1,9-9h184a9.01016,9.01016,0,0,1,9,9v44A9.01015,9.01015,0,0,1,801.81836,318.08691Z" transform="translate(-276.18187 -133.91309)" fill="#6c63ff"/>
      <circle cx="433.63626" cy="105.17383" r="20" fill="" class="primary-color"/>
      <circle cx="433.63626" cy="105.17383" r="12.18187" fill="#fff" class=""/>
    </svg>

    <p class="font-bold text-xl text-primary-emphasis ml-6 mt-8"> {{ message }} </p>
  </div>
</template>
